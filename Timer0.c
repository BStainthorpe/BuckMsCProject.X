 ...
 * with a prescaler of 32, and trigger the interrupt function in main
------------------------------------------------------------------------------*/
void setupTimer0Interrupt(){
    ...
    OPTION_REG = 0b100;         //set the prescaler as 32 this gives interrupt frequency as clockFrequency / (4*32*255) = 980Hz
